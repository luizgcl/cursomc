package com.luizgcl.cursomc.resources;
...
public class CategoriaResource {
	...
	public ResponseEntity<List<CategoriaDTO>> findAll() {
		...
		List<CategoriaDTO> categoria = list.stream().map(obj -> new CategoriaDTO(obj)).collect(Collectors.toList());
	...
	public ResponseEntity<Page<CategoriaDTO>> findPage(
		...
		Page<CategoriaDTO> categoria = list.map(obj -> new CategoriaDTO(obj));
		return ResponseEntity.ok().body(categoria);
	}
